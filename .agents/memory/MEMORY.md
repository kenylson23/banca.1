...
- [Notification preference schema](notification-preference-schema.md) — legacy databases may have payment_enabled while runtime queries require the expanded per-type preference columns.
