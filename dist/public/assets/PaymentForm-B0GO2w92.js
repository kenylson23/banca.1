import{c as Te,j as g,B as Ue,u as Pn}from"./index-Bzdgplmk.js";import{r as l,a as P,b as Ce}from"./react-vendor-DoqEe0id.js";import{f as k}from"./badge-wtXWRGq6.js";import{P as Se,x as he,q as ve,A as An,D as On,a as Tn,b as $n,e as Lt,d as jn,B as In}from"./usePrinter-D63PJcfH.js";import{a as Fn}from"./checkbox-OcK63t3C.js";import{I as st}from"./input-T18zvXH_.js";import{L as Ee}from"./label-CSMVc7Xo.js";import{S as Ln,a as Vn,b as zn,c as Bn,d as Yn}from"./select-BGSCFD5o.js";/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Eo=Te("DollarSign",[["line",{x1:"12",x2:"12",y1:"2",y2:"22",key:"7eqyqh"}],["path",{d:"M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6",key:"1b0p4s"}]]);/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Co=Te("GripVertical",[["circle",{cx:"9",cy:"12",r:"1",key:"1vctgf"}],["circle",{cx:"9",cy:"5",r:"1",key:"hp0tcf"}],["circle",{cx:"9",cy:"19",r:"1",key:"fkjjf6"}],["circle",{cx:"15",cy:"12",r:"1",key:"1tmaij"}],["circle",{cx:"15",cy:"5",r:"1",key:"19l28e"}],["circle",{cx:"15",cy:"19",r:"1",key:"f4zoj3"}]]);/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const So=Te("MessageSquare",[["path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z",key:"1lielz"}]]);/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ro=Te("Pen",[["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}]]);/**
 * @license lucide-react v0.453.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ko=Te("Split",[["path",{d:"M16 3h5v5",key:"1806ms"}],["path",{d:"M8 3H3v5",key:"15dfkv"}],["path",{d:"M12 22v-8.3a4 4 0 0 0-1.172-2.872L3 3",key:"1qrqzj"}],["path",{d:"m15 9 6-6",key:"ko1vev"}]]);function Mo({order:e,restaurantName:t="NaBancada",variant:n="outline",size:r="sm"}){l.useRef(null);const o=r==="icon",i=()=>{var f;if(!e||!e.id){console.error("Cannot print: order or order.id is undefined");return}const a=window.open("","_blank");if(!a)return;const s={pendente:"Pendente",em_preparo:"Em Preparo",pronto:"Pronto",servido:"Servido"},c={mesa:"Mesa",delivery:"Delivery",takeout:"Take-out"},u=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
    ...
    `;a.document.write(u),a.document.close()};return g.jsxDEV(Ue,{variant:n,size:r,onClick:i,disabled:!e||!e.id,"data-testid":e!=null&&e.id?`button-print-order-${e.id}`:"button-print-order-disabled",children:[g.jsxDEV(Se,{className:o?"h-4 w-4":"h-4 w-4 mr-2"},void 0,!1,{fileName:"/home/runner/workspace/client/src/components/PrintOrder.tsx",lineNumber:259,columnNumber:7},this),!o&&"Imprimir"]},void 0,!0,{fileName:"/home/runner/workspace/client/src/components/PrintOrder.tsx",lineNumber:252,columnNumber:5},this)}function Po({order:e,restaurantInfo:t={name:"NaBancada"},variant:n="outline",size:r="sm"}){l.useRef(null);const o=r==="icon",{getPrinterByType:i}=An(),{toast:a}=Pn(),[s,c]=l.useState(!1),u=i("invoice"),f=async()=>{var p;if(!e||!e.id){console.error("Cannot print invoice: order or order.id is undefined");return}c(!0);try{const m={dinheiro:"Dinheiro",multicaixa:"Multicaixa",transferencia:"Transferência Bancária",cartao:"Cartão"},x=((p=e.orderItems)==null?void 0:p.map(v=>{var y;return{name:((y=v.menuItem)==null?void 0:y.name)||"Item",quantity:v.quantity,price:k(v.price),total:k(parseFloat(v.price)*v.quantity)}}))||[],b=e.payments&&e.payments.length>0?e.payments.map(v=>m[v.paymentMethod]||v.paymentMethod).join(", "):void 0;await In.printInvoice("invoice",{invoiceNumber:e.id.substring(0,8).toUpperCase(),date:e.createdAt?he(new Date(e.createdAt),"dd/MM/yyyy",{locale:ve}):he(new Date,"dd/MM/yyyy",{locale:ve}),customerName:e.customerName||void 0,customerPhone:e.customerPhone||void 0,items:x,subtotal:k(e.subtotal||e.totalAmount),discount:e.discount&&parseFloat(e.discount)>0?k(e.discount):void 0,total:k(e.totalAmount),paymentInfo:b,notes:e.orderNotes||void 0}),a({title:"Fatura impressa",description:"Fatura enviada para impressora térmica"})}catch(m){a({title:"Erro ao imprimir",description:m instanceof Error?m.message:"Erro desconhecido",variant:"destructive"})}finally{c(!1)}},d=()=>{var v,y;if(!e||!e.id){console.error("Cannot print invoice: order or order.id is undefined");return}const p=window.open("","_blank");if(!p)return;const m={mesa:"Mesa",delivery:"Delivery",takeout:"Take-out",balcao:"Balcão",pdv:"PDV"},x={dinheiro:"Dinheiro",multicaixa:"Multicaixa",transferencia:"Transferência Bancária",cartao:"Cartão"},b=`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
